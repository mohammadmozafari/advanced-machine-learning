...
class DQN(Base_Agent):
    ...
    def learn(self, experiences=None):
        ...
        if experiences is None: states, actions, rewards, next_states, dones, _ = self.sample_experiences() #Sample experiences
        else: states, actions, rewards, next_states, dones, _ = experiences
    ...
    def sample_experiences(self):
        ...
        states, actions, rewards, next_states, dones, infoes = experiences
